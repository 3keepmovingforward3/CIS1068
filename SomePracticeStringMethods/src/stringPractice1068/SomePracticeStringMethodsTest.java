...
public class SomePracticeStringMethodsTest {
	...
	public void testAppendIfMissing() {
		assertEquals(SomePracticeStringMethods.appendIfMissing("lightning","bug"), "lightningbug");
		assertEquals(SomePracticeStringMethods.appendIfMissing("Basket","ball"), "basketball");
		assertEquals(SomePracticeStringMethods.appendIfMissing("lightningbug","bug"), "lightningbug");
	}
